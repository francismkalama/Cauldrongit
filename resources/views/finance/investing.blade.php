...
<div class="container-fluid" style="margin-top: 1%;margin-bottom: 0;">
	...
	<ul id="mynavheadertab" style="font-size: 1.5em;">
		...
		<li><a href="#" id="mynavheadertablink" class="active"> Investing</a></li>&nbsp;\
...
<div class="container-fluid" style="margin-top: 0;">
	...
	<div class="container">
		...
		<div class="row" style="margin-top: 1%;" id="aboutcaldron">
			...
			<h3 style="font-weight: bold;color:black; ">Investing</h3>
		</div>
...
With Cauldron Consulting, life does come a long your way with step- by- step instructions. We break down how to master any money related task and risks therein. To reach your financial milestone, we’ll cover the steps and whatever you need to know.
		</span>
			</div>
		</div>
