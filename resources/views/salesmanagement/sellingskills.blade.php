...
<div class="container-fluid" style="margin-top: 1%;margin-bottom: 0;padding-left: 4%;">
	...
	<ul id="mynavheadertab" style="font-size: 1.5em;">
		...
		<li><a href="{{ url('/salesmanagement/sellingskills') }}" id="mynavheadertablink" > Recruiting</a></li>&nbsp;\
		<li><a href="#" id="mynavheadertablink" class="active"> Selling skills</a></li>&nbsp;\
		<li><a href="{{ url('/salesmanagement/leadership') }}" id="mynavheadertablink"> Leadership and development </a></li>&nbsp;\
...
<div class="container-fluid" style="margin-top: 0;">
	...
	<div class="container">
		...
		<div class="row" style="margin-top: 1%;" id="aboutcaldron">
			...
			<h3 style="font-weight: bold;color:black; ">Recruiting</h3>
		</div>
