...
<nav class="navbar navbar-default" style="font-weight: bold;margin-bottom: 1%;min-height: 10px;background-color: #DDDCDC;">
  <div class="container-fluid" style="margin-left: 20%;"  >
     <ul class="nav navbar-nav" id="mynavheadertab" style="margin-bottom: 0;">
      <li class="active">Financial Consultancy&nbsp;: &nbsp;</li>
      <li class="active"><a href="#" style="padding: 0;">Budgeting&nbsp;\&nbsp;</a></li>
      <li class="active"><a href="#" style="padding: 0;">Saving&nbsp;\&nbsp;</a></li>
      <li class="active"><a href="#" style="padding: 0;">Investing&nbsp;\&nbsp;</a></li>
      <li class="active"><a href="#" style="padding: 0;">Retirement&nbsp;\&nbsp;</a></li>
      <li class="active"><a href="#" style="padding: 0;">Taxes&nbsp;\&nbsp;</a></li>
      <li class="active"><a href="#" style="padding: 0;">Insurance&nbsp;\&nbsp;</a></li>
